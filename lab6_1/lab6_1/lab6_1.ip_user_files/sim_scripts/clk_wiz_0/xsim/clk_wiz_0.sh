...
elaborate()
{
  ...
  xelab --incr --debug typical --relax --mt auto --include "%xv_boost_lib_path%"  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_0 xil_defaultlib.clk_wiz_0 xil_defaultlib.glbl -log elaborate.log
}
