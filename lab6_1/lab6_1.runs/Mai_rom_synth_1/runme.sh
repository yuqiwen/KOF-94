...
HD_PWD='C:/Users/yunxuan5/lab6_1/lab6_1.runs/Mai_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mai_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mai_rom.tcl
