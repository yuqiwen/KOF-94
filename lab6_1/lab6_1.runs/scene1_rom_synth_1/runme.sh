...
HD_PWD='C:/Users/yunxuan5/KOF-94/lab6_1/lab6_1.runs/scene1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scene1_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scene1_rom.tcl
