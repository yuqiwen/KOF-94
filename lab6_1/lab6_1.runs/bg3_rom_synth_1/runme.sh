...
HD_PWD='C:/Users/yunxuan5/KOF-94/lab6_1/lab6_1.runs/bg3_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bg3_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bg3_rom.tcl
