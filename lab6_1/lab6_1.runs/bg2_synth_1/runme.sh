...
HD_PWD='C:/Users/yunxuan5/lab6_1/lab6_1.runs/bg2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bg2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bg2.tcl
