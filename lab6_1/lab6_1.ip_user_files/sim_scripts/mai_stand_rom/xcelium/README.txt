...
#
# Generated by export_simulation on Thu Nov 16 23:34:36 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './mai_stand_rom.sh' script.

./mai_stand_rom.sh -reset_run
...
./mai_stand_rom.sh -noclean_files

For more information on the script, please type './mai_stand_rom.sh -help'.
