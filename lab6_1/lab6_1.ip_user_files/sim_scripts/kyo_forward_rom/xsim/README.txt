...
#
# Generated by export_simulation on Fri Dec 08 03:02:13 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './kyo_forward_rom.sh' script.

./kyo_forward_rom.sh -reset_run
...
./kyo_forward_rom.sh -noclean_files

For more information on the script, please type './kyo_forward_rom.sh -help'.
