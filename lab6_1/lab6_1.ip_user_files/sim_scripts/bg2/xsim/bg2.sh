...
elaborate()
{
  ...
  xelab --incr --debug typical --relax --mt auto --include "%xv_boost_lib_path%"  -L blk_mem_gen_v8_4_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bg2 xil_defaultlib.bg2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  bg2 -key {Behavioral:sim_1:Functional:bg2} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_block.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bg2.wdb xsim.dir)
