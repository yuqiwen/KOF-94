...
#
# Generated by export_simulation on Wed Nov 15 17:49:42 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './bg2.sh' script.
...
./bg2.sh -noclean_files

For more information on the script, please type './bg2.sh -help'.
