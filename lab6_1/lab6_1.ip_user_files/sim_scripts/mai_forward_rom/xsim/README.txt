...
#
# Generated by export_simulation on Thu Nov 30 16:14:35 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './mai_forward_rom.sh' script.

./mai_forward_rom.sh -reset_run
...
./mai_forward_rom.sh -noclean_files

For more information on the script, please type './mai_forward_rom.sh -help'.
