...
#
# Generated by export_simulation on Thu Dec 07 02:34:47 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './kyo_squat_rom.sh' script.

./kyo_squat_rom.sh -reset_run
...
./kyo_squat_rom.sh -noclean_files

For more information on the script, please type './kyo_squat_rom.sh -help'.
