...
#
# Generated by export_simulation on Tue Nov 21 16:44:26 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './mai_punch_rom.sh' script.

./mai_punch_rom.sh -reset_run
...
./mai_punch_rom.sh -noclean_files

For more information on the script, please type './mai_punch_rom.sh -help'.
