...
#
# Generated by export_simulation on Thu Nov 30 18:48:56 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './kyo_punch_rom.sh' script.

./kyo_punch_rom.sh -reset_run
...
./kyo_punch_rom.sh -noclean_files

For more information on the script, please type './kyo_punch_rom.sh -help'.
